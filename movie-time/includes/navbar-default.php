        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="myprofile.php"><span class="glyphicon glyphicon-user"></span>  Voir mon profil</a></li>
              <li><a href="#"><span class="glyphicon glyphicon-briefcase"></span>  Mes emprunt</a></li>
