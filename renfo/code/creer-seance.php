...
$sql = "select name from renfo_exercise_type;";
...
<body>
			...
			<div class="col align-self-center">
				<div class="card text-center">
				  <div class="card-header bg-dark text-light">
				    Remplis ce formulaire pour créer ta séance ! Tu trouveras quelques conseils <a class="text-info" href="#conseils">juste ici</a> 👊
				  </div>
				  <div class="card-body">
				    <form method="POST" action="functions/seance_builder_v2.php" class="form">
				      <div class="form-group row">
				        <label for="seance_name" class="col-sm-4 col-form-label">Donnes lui un nom</label>
				        <div class="col-sm-8">
				          <input type="text" class="form-control" name="seance_name" id="seance_name">
				        </div>
				      </div>
				      <div class="form-group row">
				        ...
				        <div class="form-group row">
				          <label for="type" class="col-sm-4 col-form-label">Quelle difficultée pour cette séance ?</label>
				          <div class="col-sm-8 ">
	...
	<div class="container" id="conseils">
		<div class="row">
			<div class="col">
				<h2>Conseils pour créer ta séance</h2>
		...
		<div class="row">
			<div class="col">
				...
				<p>Le formulaire va t'aider à construire ta séance, exercice par exercice. Commence par choisir un exercice, puis indiques le nombre de séries que tu souhaites faire.</p>
	...
	<script type="text/javascript">
		...
		$('.add-exercise').click(function(e){
			...
			$('.exercise-load:last').load("./includes/exercise_form.php",{"exercise_id":exerciseId,"seance_type":$('#type')[0].value});
