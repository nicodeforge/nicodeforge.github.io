		...
		# code...
			...
			if ($count > 2) {
				for ($i = (2*$series1)+(2*$series2); $i < (2*$series1)+(2*$series2)+(2*$series3); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice3,"length" => $time3));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup3));
					$i++;
			...
			if ($count > 3) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice4,"length" => $time4));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup4));
					$i++;
			...
			if ($count > 4) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice5,"length" => $time5));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup5));
					$i++;
			...
			if ($count > 5) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice6,"length" => $time6));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup6));
					$i++;
			...
			if ($count > 6) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice7,"length" => $time7));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup7));
					$i++;
			...
			if ($count > 7) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7)+(2*$series8); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice8,"length" => $time8));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup8));
					$i++;
			...
			if ($count > 8) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7)+(2*$series8); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7)+(2*$series8)+(2*$series9); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice9,"length" => $time9));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup9));
					$i++;
			...
			if ($count > 9) {
				for ($i = (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7)+(2*$series8)+(2*$series9); $i < (2*$series1)+(2*$series2)+(2*$series3)+(2*$series4)+(2*$series5)+(2*$series6)+(2*$series7)+(2*$series8)+(2*$series9)+(2*$series10); $i++) {
					array_push($programContent,array("id" => $i, "name" => $exercice10,"length" => $time10));
					array_push($programContent,array("id" => $i+1, "name" => "Pause","length" => $recup10));
					$i++;
			...
			if (isset($progname) && $progname != "" && isset($programContent) && $programContent != "" && $programContent != "unset") {
				...
				$sql = "INSERT INTO renfo_program (user_id,name,slug,type,content,difficulty) VALUES ('".$user."', '".$progname."', '".$slug."', '".$type."', '".$programContent."','".$difficulty."')";
