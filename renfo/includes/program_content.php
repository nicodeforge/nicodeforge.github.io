<div class="container" id="program-content" style="display: none;">
	<div class="row">
				...
				<div class="container program-content">
					<div class="row">
						<div class="col-sm text-center">
							...
							<p class="next">A suivre : <span class="exercise-next"></span><span class="exercise-next-timing"> : <span class="exercise-next-length"></span>s</span></p>
						</div>
					</div>
				</div>
			</div>
